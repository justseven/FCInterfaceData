...
namespace Tools
{
    public class FTPHelper
    {
        ...
        public string GetBase64StringFrmFtp(string filePath, string ftpdir, string fileName, FTP ftpSvr)
        {
            FtpWebRequest reqFTP;
            try
            {
                ...
                FtpWebResponse response = (FtpWebResponse)reqFTP.GetResponse();
                Stream ftpStream = response.GetResponseStream();
                string base64String = Convert_To_Base64(ftpStream);
                return base64String;
            }
            catch (Exception ex)
            {
        ...
        private string Convert_To_Base64(string source)
        {
        ...
        private string Convert_To_Base64(byte[] buffer)
        {
            //将字节流转化成base64字符串
            return Convert.ToBase64String(buffer);
        ...
        private string Convert_To_Base64(Stream stream)
        {
