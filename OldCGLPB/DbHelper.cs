...
namespace OldCGLPB
{
    ...
    public abstract class DbHelper
    {
        ...
        public static IDbBase Provider = new DbBase(MyDBType.Oracle);
        ...
        public static string CreateInsertStr<T>(T t,string tableName,MyDBType mydbtype)
         {
        ...
        public static string CreateInsertStr<T>(T t, MyDBType mydbtype)
        {
        ...
        public static string CreateSelectStr<T>(T t, string tableName, MyDBType mydbtype)
        {
        ...
        public static string CreateSelectStr<T>(T t, MyDBType mydbtype)
        {
        ...
        private static bool CanAdd(string name,string tablename)
        {
        ...
        public static int ExecuteNonQuery(MyDBType mydbtype,CommandType cmdType, string cmdText, params DbParameter[] commandParameters)
        {
        ...
        public static void Oracle_UseSqlBulkCopy(DataTable dt)
        {
        ...
        /// <param name="dt"></param>
        public static void SQL_UseSqlBulkCopy(DataTable dt)
        {
        ...
        //public static int ExecuteNonQuery(int connIndex,CommandType cmdType, string cmdText, params DbParameter[] commandParameters)
        //{
        //    if(connIndex==0)
        ...
        public static DbDataReader ExecuteReader(MyDBType mydbtype, CommandType cmdType, string cmdText, params DbParameter[] commandParameters)
        {
            //string connstr = string.Empty;
            //switch (mydbtype)
            //{
        ...
        public static object ExecuteScalar(MyDBType mydbtype, CommandType cmdType, string cmdText, params DbParameter[] commandParameters)
        {
            //string connstr = string.Empty;
            //switch (mydbtype)
            //{
        ...
        public static DataTable ExecuteTable(MyDBType mydbtype, CommandType cmdType, string cmdText, params DbParameter[] commandParameters)
        {
            //string connstr = string.Empty;
            //switch (mydbtype)
            //{
        ...
        /// <param name="PageCount">输出参数，返回查询的总页�?/param>
        /// <returns>返回查询结果</returns>
        public static DataTable ExecutePage(MyDBType mydbtype, string SqlAllFields, string SqlTablesAndWhere, string IndexField, string OrderFields, int PageIndex, int PageSize, out int RecordCount, out int PageCount, params DbParameter[] commandParameters)
        {
            //string connstr = string.Empty;
            //switch (mydbtype)
            //{
        ...
        public static string CreateUpdateStr<T>(T t, string tableName,string keyStr, MyDBType myDBType)
        {
