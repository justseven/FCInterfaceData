...
namespace XZFCDA.Tools
{
    public class FTPHelper
    {
        ...
        public static void UploadFile(FileInfo fileinfo, string targetDir, FTP ftpSrv,bool DeleteSource)
        {
            //1. check target
            string target;
            if (targetDir.Trim() == "")
            ...
            string URI = "FTP://" + ftpSrv.hostname + "/" + targetDir + "/" + target;
        ...
        /// ftp方式上传 
        /// </summary>
        public static int UploadFtp(string filePath, string filename,string FtpDir, FTP ftpSvr)
        {
            string path = "";
            ...
            string uri = "ftp://" + ftpSvr.hostname + "/" + FtpDir + "/" + fileInf.Name;
        ...
        /// <param name="username">ftp用户名</param>
        /// <param name="password">ftp密码</param>
        public static string DownloadFile(string localDir, string FtpDir, string FtpFile, FTP ftpserver)
        {
            string URI = "";
            if (FtpDir.Equals(""))
            {
        ...
        /// ftp方式下载 
        /// </summary>
        public static string DownloadFtp(string filePath, string ftpdir,string fileName, FTP ftpSvr)
        {
            FtpWebRequest reqFTP;
            try
            {
                ...
                if(ftpdir.Equals(""))
                {
                    uri = "ftp://" + ftpSvr.hostname + "/" + fileName;
                }
                else
                {
                    uri = "ftp://" + ftpSvr.hostname + "/" + ftpdir + "/" + fileName;
                }
                reqFTP = (FtpWebRequest)FtpWebRequest.Create(new Uri(uri));
        ...
        /// <returns></returns>
        public static List<string> ListDirectory(string targetDir, FTP ftpSrv, string SearchPattern)
        {
            List<string> result = new List<string>();
            try
            {
                string URI = "FTP://" + ftpSrv.hostname + "/" + targetDir + "/" + SearchPattern;
        ...
        public static void MakeDir(string dirName, FTP ftpSrv)
        {
            try
            {
        ...
        public void Rename(string currentFilename, string newFilename, FTP ftpSrv)
        {
            try
            {
                ...
                string uri = "ftp://" + ftpSrv.hostname + "/" + fileInf.Name;
                System.Net.FtpWebRequest ftp = GetRequest(uri, ftpSrv.username, ftpSrv.password);
        ...
        /// <returns></returns>
        public static bool DirectoryExist(string dirName, FTP ftpSrv)
        {
